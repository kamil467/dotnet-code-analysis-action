...
public class ProjectWorkspace : IDisposable
{
    ...
    async Task<ProjectInfo> CreateProjectInfoAsync(ProjectFileInfo projectFileInfo, string projectDirectory)
    {
        ...
        static CommandLineParser GetCommandLineParser(bool isCSharp) => CSharpDefaults.CommandLineParser;
        ...
        static CompilationOptions GetCompilationOptions(bool isCSharp) => CSharpDefaults.CompilationOptions;
